...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/nikhil-amin/togetherplan.git # Replace with your repo URL
    cd togetherplan
    ```
...
2.  **`basePath` Configuration (Crucial for GitHub Pages):**
    ...
    ```
    For example, if your repository is named `togetherplan`, set `basePath: '/togetherplan'`. If you deploy to `nikhil-amin.github.io` directly (by naming your repository `nikhil-amin.github.io`), then `basePath` is not needed (set it to `''` or remove it).
        ...
        jobs:
          build-and-deploy:
            ...
            env: # Pass your Firebase public env vars here
              ...
              # For example, if your repo is 'togetherplan', basePath should be '/togetherplan'
